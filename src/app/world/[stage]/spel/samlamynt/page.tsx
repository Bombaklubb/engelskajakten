    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 pt-16">
        <div className="text-center max-w-sm w-full">
          ...
          <Link prefetch={false} href={`/world/${stageId}?tab=spel`} className="mt-4 block text-gray-400 hover:text-gray-600 text-sm transition">← Tillbaka</Link>
        </div>
      </div>
    </div>
  );
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="text-center max-w-sm w-full">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link prefetch={false} href={`/world/${stageId}?tab=spel`} className="text-gray-400 hover:text-gray-600 text-sm transition">← Tillbaka till Spel</Link>
          </div>
        </div>
      </div>
    </div>
