...
// DiceBear API – webbläsaren hämtar direkt, fungerar utan backend
const DB = "https://api.dicebear.com/9.x";
const ADV = `${DB}/adventurer/svg`;   // karaktärsavatarer
const BOT = `${DB}/bottts/svg`;       // robot
const PIX = `${DB}/pixel-art/svg`;    // ninja (retro-stil)
const EMO = `${DB}/fun-emoji/svg`;    // spöket
